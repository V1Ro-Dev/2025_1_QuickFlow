...
func (m *MockFileUseCase) GetFileURL(ctx context.Context, filename string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockFileUseCaseMockRecorder) GetFileURL(ctx, filename interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFileURL", reflect.TypeOf((*MockFileUseCase)(nil).GetFileURL), ctx, filename)
}
