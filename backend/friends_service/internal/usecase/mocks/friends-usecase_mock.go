...
// Source: .//friends_service/internal/usecase/friends-usecase.go
...
func (m *MockFriendsRepository) GetFriendsPublicInfo(ctx context.Context, userID string, amount, startPos int, reqType string) ([]models.FriendInfo, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFriendsPublicInfo", ctx, userID, amount, startPos, reqType)
...
func (mr *MockFriendsRepositoryMockRecorder) GetFriendsPublicInfo(ctx, userID, amount, startPos, reqType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFriendsPublicInfo", reflect.TypeOf((*MockFriendsRepository)(nil).GetFriendsPublicInfo), ctx, userID, amount, startPos, reqType)
}
...
func (m *MockFriendsRepository) MarkRead(ctx context.Context, user1, user2 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockFriendsRepositoryMockRecorder) MarkRead(ctx, user1, user2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkRead", reflect.TypeOf((*MockFriendsRepository)(nil).MarkRead), ctx, user1, user2)
}
